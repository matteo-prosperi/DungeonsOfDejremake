...
The compiled builds released by this project contain **none** of the original
game's copyrighted content. They ship only original, project-authored code and
assets (including independently created replacement art and audio).

To play, a user supplies their **own copy** of the original game; the software
then extracts the required data locally on the user's own device. This project
neither distributes nor transmits the original game's copyrighted data, artwork,
or audio in extracted or transformed form.

## Bundled shareware

For user convenience, the freely redistributable **shareware ("PUBLIC")**
distribution of the original game is included at
[`tests/fixtures/MORDOR11.ZIP`](tests/fixtures/MORDOR11.ZIP). Redistribution of
this shareware package is **explicitly permitted by the original publisher**. The
bundled shareware documentation (`MORDOR.WRI`) states:

> "Please feel free to distribute the PUBLIC (Shareware) version of MORDOR as you
> wish."
